...
public class PairsCount extends Configured implements Tool {
    ...
    private static final Logger logger = Logger.getLogger(pjdk.cooccurence.pairs.PairsCountPartitioner.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        int res = ToolRunner.run(new Configuration(), new pjdk.cooccurence.pairs.PairsCountPartitioner(), args);
    ...
    public int run(String[] arg0) throws Exception {
        ...
        job.setJarByClass(pjdk.cooccurence.pairs.PairsCountPartitioner.class);
