...
public class PairsCountInMapLocal extends Configured implements Tool {

    private static final Logger logger = Logger.getLogger(PairsCountInMapLocal.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        int res = ToolRunner.run(new Configuration(), new PairsCountInMapLocal(), args);
    ...
    public int run(String[] arg0) throws Exception {
        ...
        job.setJarByClass(PairsCountInMapLocal.class);
        ...
        job.setMapperClass(WordCounterMapInMapperLocal.CoOccurrenceMapperInMapper.class);
