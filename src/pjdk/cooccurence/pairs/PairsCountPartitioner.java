...
public class PairsCountPartitioner extends Configured implements Tool {

    private static final Logger logger = Logger.getLogger(PairsCountPartitioner.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        int res = ToolRunner.run(new Configuration(), new PairsCountPartitioner(), args);
    ...
    public int run(String[] arg0) throws Exception {
        ...
        job.setJarByClass(PairsCountPartitioner.class);
